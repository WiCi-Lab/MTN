...
class channel_est(nn.Module):
    def __init__(self):
        ...
        self.Up33 = conv_block1(filters[1], filters[1],1,1,1)
        

        self.Up2 = up_conv(filters[1], filters[0])
        self.Up22 = conv_block1(filters[0], filters[0],1,1,1)
        ...
        self.Up221 = conv_block1(filters[0], filters[0],1,1,1)
